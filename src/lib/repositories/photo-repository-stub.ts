...
const mockPhotos: Photo[] = [
  {
    ...
    isPublic: true,
    storageUrl: '/images/gallery/commercial-building-001.jpg',
    thumbnailUrl: '/images/gallery/thumbs/commercial-building-001.jpg',
    watermarkUrl: '/images/gallery/watermarked/commercial-building-001.jpg',
    price: 25.00,
  ...
  },
  {
    ...
    isPublic: true,
    storageUrl: '/images/gallery/residential-home-001.jpg',
    thumbnailUrl: '/images/gallery/thumbs/residential-home-001.jpg',
    watermarkUrl: '/images/gallery/watermarked/residential-home-001.jpg',
    price: 15.00,
    metadata: createDefaultPhotoMetadata({
